...
<x-teachers-layout>
    ...
    <div class="p-4 mt-20 animate-fade-in">
        <form action="{{ route('ttest.store') }}" method="POST" enctype="multipart/form-data" onsubmit="return validateForm(event)" class="max-w-7xl mx-auto pb-20 px-4 space-y-8">
            ...
            <div id="question-bank-header" class="sticky top-16 z-30 space-y-3">
                <div class="bg-white/95 backdrop-blur-2xl border border-indigo-100/70 shadow-2xl shadow-indigo-100/40 rounded-[2rem] px-6 py-4 flex flex-col lg:flex-row justify-between items-center gap-4">
                    <div class="flex items-center gap-4 w-full lg:w-auto">
                        <div class="h-12 w-12 bg-slate-900 text-white rounded-2xl flex items-center justify-center font-black shadow-lg flex-shrink-0">
            ...
            <div id="questions-container" class="space-y-6 min-h-[100px]"></div>
...
<script>
    // เริ่มต้นเพิ่มข้อสอบ 1 ข้อแรกหากยังไม่มีข้อสอบ
